        ...
        child: Container(
          ...
          child: Row(
            ...
            children: [
              ...
              Text(widget.searchTabLabel, style: const TextStyle(fontSize: 13, fontWeight: FontWeight.w600)),
            ],
          ),
        ),
      ));
        ...
        child: Container(
          ...
          child: Row(
            ...
            children: [
              ...
              const SizedBox(width: 6),
              Text(widget.gpsTabLabel, style: const TextStyle(fontSize: 13, fontWeight: FontWeight.w600)),
            ],
          ),
        ),
      ));
        ...
        child: Container(
          ...
          child: Row(
            ...
            children: [
              ...
              const SizedBox(width: 6),
              Text(widget.manualTabLabel, style: const TextStyle(fontSize: 13, fontWeight: FontWeight.w600)),
            ],
          ),
        ),
      ));
